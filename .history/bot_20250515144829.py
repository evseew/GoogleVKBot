...
async def chat_with_assistant(user_id: int, message_text: str) -> str:
    ...
    try:
        ...
        if assistant_response:
            ...
            return "Произошла внутренняя ошибка (ответ ассистента не найден или не соответствовал текущему запросу)."
...
async def main():
    ...
    cleanup_task = None # Инициализация
    listen_task = None  # Инициализация
    ...
    try:
        ...
        await asyncio.gather(
            cleanup_task if cleanup_task else asyncio.sleep(0),
